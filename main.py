...
def main_menu():
	...
	while not libtcod.console_is_window_closed():
		...
		libtcod.console_print_ex(0, int(SCREEN_WIDTH / 2), int(SCREEN_HEIGHT / 2 - 6), libtcod.BKGND_NONE, libtcod.CENTER, "Roguelike thinger")
		libtcod.console_print_ex(0, int(SCREEN_WIDTH / 2), int(SCREEN_HEIGHT / 2 - 4), libtcod.BKGND_NONE, libtcod.CENTER, "Written by Cody Kelly and Roguebasin")
